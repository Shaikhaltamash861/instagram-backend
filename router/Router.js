...
const {signup,signin, getUserById, getUserByUserName, followUser, getFollowers, getFollowing, changeProfile, getSuggestion}=require('../controller/userContriller');
const { post,getPost, addComment, getPostMyFollowing, whoCommented, likePost, deletePost, getRandomPost } = require('../controller/postController');
...
router.get('/retrive/suggestions',getSuggestion)
